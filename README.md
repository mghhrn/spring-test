...
Disclaimer: This repo is almost a complete copy of https://github.com/hamvocke/spring-testing. I just convert it to work with maven instead of gradle.
...
##  Run the Application
Once you've provided the API key and started a PostgreSQL database you can run the application using your STS. Right click on project and select: "Run As" --> "Spring Boot App"
